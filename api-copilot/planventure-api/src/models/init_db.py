...
from src.models import db, User, Trip
...
def seed_db():
    ...
    trips = [
        Trip(
            ...
            end_date=datetime.now(datetime.timezone.utc) + timedelta(days=33),
            itinerary={
                "day1": {
        ...
        Trip(
            ...
            latitude=35.6762,
            longitude=139.6503,
            start_date=datetime.now(datetime.timezone.utc) + timedelta(days=60),
            end_date=datetime.now(datetime.timezone.utc) + timedelta(days=67),
            itinerary={
                "day1": {
